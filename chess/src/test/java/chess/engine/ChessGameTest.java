...
public class ChessGameTest {
    ...
    public void testCastling() {
        Piece[][] initialBoard = {
            {wr2, null, null, wb1, wk, null, null, wr1},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {bb1, null, null, null, null, null, null, null},
            {null, null, null, wb2, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {br2, null, null, null, bk, null, null, br1}
        };
        Piece[][] afterWhiteCastling = {
            {wr2, null, null, wb1, null, wr1, wk, null},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {bb1, null, null, null, null, null, null, null},
            {null, null, null, wb2, null, null, null, null},
        ...
        Piece[][] afterBlackCastling = {
            ...
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {null, null, bk, br2, null, null, null, br1}};
        ...
        int[][] moves = {
            {4, 0, 2, 0}, // Invalid move (Bishop in the way)
            {4, 0, 6, 0}, // Valid move
            {4, 7, 6, 7}, // Invalid move (position threatened by white rook)
            {4, 7, 2, 7}, // Valid move (even though the rooks are threatened)
        };

        testTurns(turns, moves);
    }

    @Test
    public void testPieceCapture() {
        Piece[][] initialBoard = {
            {wr2, null, null, null, wk, null, null, wr1},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
        ...
        Piece[][] afterCapture = {
            ...
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {br2, null, null, null, bk, null, null, wr1}
        };
        ...
        int[][] moves = {
            {7, 0, 7, 7} // White rook captures black rook
        };
    ...
    public void testPawnCapture() {
        ...
        int[][] moves = {
            {1, 1, 2, 2} // White pawn captures black pawn
        };
    ...
    public void testKnightCapture() {
        Piece[][] initialBoard = {
            ...
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {wk1, null, null, null, null, null, null, bk1}
        };
        Piece[][] afterCapture = {
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            ...
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, wk1, null}
        };
        ...
        int[][] moves = {
            {0, 7, 6, 7} // White knight captures black knight
        };
    ...
    public void testPawnBlocking() {
        ...
        Piece[][][] turns = {
            initialBoard,
            initialBoard // State should remain the same after invalid move
        };

        int[][] moves = {
            {0, 0, 0, 1} // Invalid move (white rook blocked by white pawn)
        };
    ...
    @Test
    public void testBishopBlocking() {
        Piece[][] initialBoard = {
            {wr2, null, null, null, wk, null, null, wr1},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {null, null, null, wb1, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {null, null, null, null, null, null, null, null},
            {br2, null, null, null, bk, null, null, br1}
        };
        ...
        int[][] moves = {
            {0, 0, 3, 3} // Invalid move (white rook blocked by white bishop)
        };
    ...
    public void testInvalidKingMove() {
        ...
        int[][] moves = {
            {4, 0, 4, 2} // Invalid move (king cannot move two squares forward)
        };
    ...
    public void testInvalidKnightMove() {
        ...
        int[][] moves = {
            {0, 0, 1, 2} // Invalid move (rook cannot move like a knight)
        };
